...
const TareasPage = () => {
    ...
    useEffect(() => {
        fetch('https://examen-final-desarrollo-web-backend.onrender.com/api/to-do/all')
    ...
    const handleUpdate = () => {
        fetch(`https://examen-final-desarrollo-web-backend.onrender.com/api/to-do/update/${selectedTarea.id_proyecto}`, {
            method: 'PUT',
